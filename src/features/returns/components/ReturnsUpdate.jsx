            ...
            <div className="grid grid-cols-2 gap-22">
                ...
                <div className="min-h-[500px] bg-white p-8 rounded-xl w-3xl mt-40">
                    ...
                    <form onSubmit={handleSubmitDevolutivo} className="flex flex-col gap-4">
                        ...
                        <h2 className="text-xl font-semibold mb-4 place-self-center">Actualizar Devolución de Material Devolutivo</h2>
                ...
                <div className="min-h-[500px] bg-white p-8 rounded-xl w-3xl mt-40">
                    ...
                    <h2 className="text-xl font-semibold mb-4 place-self-center">Actuzalizar Devolución de Material Consumible</h2>
