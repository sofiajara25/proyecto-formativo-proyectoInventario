...
export default function ReturnableUpdateForm() {
...
return (
    ...
    <div className="bg-white p-8 rounded-xl w-full max-w-6xl">
        <h1 className="text-primary text mb-">Actualizar Material Devolutivo</h1>
        ...
        <div className="grid grid-cols-3 gap-6 mx-auto">
            ...
            name="valueUnique"
            type="number"
            value={formData.valueUnique}
            onChange={handleChange}
            error={errors.valueUnique} 
            />
