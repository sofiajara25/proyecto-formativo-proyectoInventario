...
export default function ConsumableRowActions({ consumable }) {
    ...
    const canView = hasPermission("view_consumable_material");
    const canModify = hasPermission("modify_consumable_material");
