...
export default function CategoryRowActions({ category }) {
    ...
    const handleEdit = () => {
        navigate(`/dashboard/categorys/${category.category_id}/edit`);
    };

        // Acción para ver el préstamo
    const handleView = () => {
        navigate(`/dashboard/categorys/${category.category_id}/view`);
    };



    const canView = hasPermission("view_category");
    const canModify = hasPermission("modify_category");
