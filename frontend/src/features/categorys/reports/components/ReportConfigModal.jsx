...
import { categoryReportFields } from "../config/categoryReportFields";
import { generateCategoryReport } from "../services/generateCategoryReport";
...
export default function ReportConfigModal({ isOpen, onClose }) {
    ...
    const [selectedFields, setSelectedFields] = useState(
        () => categoryReportFields.filter((f) => f.default),
    );
    ...
    const handleGenerateReport = () => {
        generateCategoryReport({ format, selectedFields, scope, name });
        onClose();
    };
            ...
            >
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {categoryReportFields.map((field) => {
