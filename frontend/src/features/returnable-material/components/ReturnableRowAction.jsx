...
export default function ReturnableRowAction({ retornable }) {
    ...
    const handleView = () => {
        navigate(`/dashboard/retornables/${retornable.id}/view`);
    };


    const canView = hasPermission("view_returnable_material");
    const canModify = hasPermission("modify_returnable_material");
