...
export default function InventoryNameRowActions({ inventoryName }) {
    ...
    const handleEdit = () => {
        navigate(`/dashboard/inventory-names/${inventoryName.inventory_name_id}/edit`);
    };

        // Acción para ver el préstamo
    const handleView = () => {
        navigate(`/dashboard/inventory-names/${inventoryName.inventory_name_id}/view`);
    };



    const canView = hasPermission("view_inventory_name");
    const canModify = hasPermission("modify_inventory_name");
