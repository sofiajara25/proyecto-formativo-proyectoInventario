...
export function generateExcelReport({
    ...
    fileName = "inventory-name-report.xlsx"  // Nombre del archivo de salida
}) {


    const currenDate = new Date().toLocaleDateString();
    const reportTitle = `   **********   REPORTE DE NOMBRES DE INVENTARIOS - ${currenDate}  **********`;
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Nombre de Inventario");
