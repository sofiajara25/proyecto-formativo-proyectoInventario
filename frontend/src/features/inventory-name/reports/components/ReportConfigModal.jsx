...
import { inventoryNameReportFields } from "../config/InventoryNameReportFields";
import { generateInventoryNameReport } from "../services/generateInventoryNameReport";
...
export default function ReportConfigModal({ isOpen, onClose }) {
    ...
    const [selectedFields, setSelectedFields] = useState(
        () => inventoryNameReportFields.filter((f) => f.default),
    );
    ...
    const handleGenerateReport = () => {
        generateInventoryNameReport({ format, selectedFields, scope, name });
        onClose();
    };
            ...
            >
                ...
                <div className="flex flex-col gap-1">
                    <h2 style={{ fontSize: "var(--fs-sm)", fontWeight: "var(--font-weight-bold)", color: "var(--color-gray-900)", margin: 0 }}>
                        Generar reporte de nombre de inventario
                    </h2>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {inventoryNameReportFields.map((field) => {
                ...
                <div className="flex flex-col gap-3">
                    <Select
                        ...
                        options={[
                            { label: "Todos los nombres de inventarios", value: "all" },
